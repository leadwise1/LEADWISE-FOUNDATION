    ...
    <div className="bg-cream min-h-screen text-navy font-oswald">
      ...
      <section className="pt-40 pb-20 px-6 container-custom">
        <div className="text-center mb-16 max-w-4xl mx-auto">
          ...
          <p className="text-navy/80 text-lg md:text-xl leading-relaxed font-light mb-8 max-w-3xl mx-auto">
           At LeadWise, we know that talent is distributed equally, but opportunity is not. That’s why we built the LeadWise Career Acceleration Platform. By merging cutting-edge technology with our evidence-based 
            leadership curriculum, we’ve created a "Mission Control" for your career—giving you the insights usually reserved for executive coaching clients.
          </p>
