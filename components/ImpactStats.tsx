...
import { Users, GraduationCap, BookOpen, Handshake, Sparkles, LucideIcon } from 'lucide-react'
...
const ImpactStats: React.FC = () => {
  ...
  const stats: Stat[] = [
    { number: '50', label: 'Leaders Trained', suffix: '+', icon: Users, description: 'Engaged & Empowered' },
    { number: '95', label: 'Our Students', suffix: '%', icon: GraduationCap, description: 'Completion Rate' },
    { number: '100', label: 'Curriculum', suffix: '%', icon: BookOpen, description: 'Tuition Free' },
    { number: '15', label: 'Corporate Partners', suffix: '+', icon: Handshake, description: 'Top Organizations' },
    { number: '96', label: 'Interview Rate', suffix: '%', icon: Sparkles, description: 'Secures Within 90 Days' }
  ]
  ...
  return (
    <section ref={sectionRef} id="impact" className="relative bg-cream text-navy py-24 overflow-hidden">
      {/* Background Pattern */}
