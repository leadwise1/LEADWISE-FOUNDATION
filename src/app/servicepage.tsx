      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="https://www.letsleadwise.org#about" className="text-gray-300 hover:text-cyan-400 transition-colors">About</a>
            <a href="https://www.letsleadwise.org#programs" className="text-gray-300 hover:text-cyan-400 transition-colors">Programs</a>
            <a href="https://www.letsleadwise.org#impact" className="text-gray-300 hover:text-cyan-400 transition-colors">Impact</a>
            <a href="https://app.letsleadwise.org" className="btn-primary px-6 py-3 rounded-xl font-orbitron text-sm tracking-wider">
              LAUNCH APP
            </a>
          </div>

          <button className="md:hidden text-white" onClick={() => window.toggleMobileMenu()}>
        ...
        <div id="mobile-menu" className="hidden md:hidden glass border-t border-white/10">
          <div className="px-6 py-4 space-y-4">
            <a href="https://www.letsleadwise.org#about" className="block text-gray-300 hover:text-cyan-400">About</a>
            <a href="https://www.letsleadwise.org#programs" className="block text-gray-300 hover:text-cyan-400">Programs</a>
            <a href="https://www.letsleadwise.org#impact" className="block text-gray-300 hover:text-cyan-400">Impact</a>
            <a href="https://app.letsleadwise.org" className="block btn-primary px-6 py-3 rounded-xl font-orbitron text-sm text-center tracking-wider">
              LAUNCH APP
            </a>
          </div>
        </div>
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Add more cards here, same structure */}
          </div>
        </div>
      </section>
    </div>
